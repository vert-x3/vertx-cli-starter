...
----
# Bash
curl https://gist.githubusercontent.com/cescoffier/cfd46c2614f54d5e2a88d5fdc4b828ed/raw/453bc44856bb93f1c31fbe8b08a285793b0134cd/create-project-maven.sh -o vertx-create-cli-project.sh && bash vertx-create-cli-project.sh
